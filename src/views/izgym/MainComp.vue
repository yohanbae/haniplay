...
.loading-wrap {
   ...
   .minju{
        background:url('../../assets/images/minju1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .wonyoung{
        background:url('../../assets/images/wonyoung1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .nako{
        background:url('../../assets/images/nako1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .eunbi{
        background:url('../../assets/images/eunbi1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yena{
        background:url('../../assets/images/yena1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yuri{
        background:url('../../assets/images/yuri1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .sakura{
        background:url('../../assets/images/sakura1.jpg');
        background-size:cover;
        background-position: right no-repeat;
    }
    .hitomi{
        background:url('../../assets/images/hitomi1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yujin{
        background:url('../../assets/images/yujin1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }    
    .hyewon{
        background:url('../../assets/images/hyewon1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaewon{
        background:url('../../assets/images/chaewon1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaeyeon{
        background:url('../../assets/images/chaeyeon1.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    ...
    //2
    .minju2{
        background:url('../../assets/images/minju2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .wonyoung2{
        background:url('../../assets/images/wonyoung2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .nako2{
        background:url('../../assets/images/nako2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .eunbi2{
        background:url('../../assets/images/eunbi2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yena2{
        background:url('../../assets/images/yena2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yuri2{
        background:url('../../assets/images/yuri2.jpg');
        background-size:cover;
        background-position: left no-repeat;
    }
    .sakura2{
        background:url('../../assets/images/sakura2.jpg');
        background-size:cover;
        background-position: right no-repeat;
    }
    .hitomi2{
        background:url('../../assets/images/hitomi2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yujin2{
        background:url('../../assets/images/yujin2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }    
    .hyewon2{
        background:url('../../assets/images/hyewon2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaewon2{
        background:url('../../assets/images/chaewon2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaeyeon2{
        background:url('../../assets/images/chaeyeon2.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    ...
    //3
    .minju3{
        background:url('../../assets/images/minju3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .wonyoung3{
        background:url('../../assets/images/wonyoung3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .nako3{
        background:url('../../assets/images/nako3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .eunbi3{
        background:url('../../assets/images/eunbi3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yena3{
        background:url('../../assets/images/yena3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yuri3{
        background:url('../../assets/images/yuri3.jpg');
        background-size:cover;
        background-position: right no-repeat;
    }
    .sakura3{
        background:url('../../assets/images/sakura3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .hitomi3{
        background:url('../../assets/images/hitomi3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .yujin3{
        background:url('../../assets/images/yujin3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }    
    .hyewon3{
        background:url('../../assets/images/hyewon3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaewon3{
        background:url('../../assets/images/chaewon3.jpg');
        background-size:cover;
        background-position: center no-repeat;
    }
    .chaeyeon3{
        background:url('../../assets/images/chaeyeon3.jpg');
        background-size:cover;
        background-position: left no-repeat;
    }    
